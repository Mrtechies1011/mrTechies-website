      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mb-20">
            ...
            <p className="text-brand-blue"><Link href='/blog/how-to-choose-best-web-designing-company-hyderabad'>How to Choose Best Web Designing Company Hyderabad?</Link></p>
          </div>
