      ...
      <section className="bg-gradient-to-br from-slate-50 to-sky-50/50 py-28 border-b">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold mt-6 text-slate-900 leading-tight">
            Elite <span className="text-sky-700">Google Ads Management</span> for Growth
          </h1>
          <p className="mt-6 text-lg md:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
            Stop losing budget to broad, irrelevant searches. As a premier <strong className="text-slate-900">pay per click advertising company</strong>, we build keyword architectures focused on <strong className="text-slate-900">commercial intent</strong>, ensuring maximum <strong className="text-slate-900">ad spend optimization</strong>.
          </p>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-4 text-gray-600 leading-relaxed">
              Most accounts bleed money by relying on automated recommendations. These prioritize click volume over intent, matching your ads against informational queries rather than purchase-ready decisions. Our <strong className="text-slate-900">performance marketing agency</strong> approach flips this model.
            </p>
          </div>
          <div className="space-y-6">
            <div className="p-5 border-l-4 border-sky-700 bg-sky-50/30 rounded-r-xl">
              <h4 className="font-bold text-slate-900">Unscrubbed Search Queries</h4>
              <p className="text-sm text-gray-600 mt-1">Failing to block casual research-based terms triggers high traffic with zero conversion potential.</p>
            </div>
            <div className="p-5 border-l-4 border-sky-700 bg-sky-50/30 rounded-r-xl">
